...
def parse_multiple_parameters(req, resp, resource, params):
    ...
    """
    query_params = OrderedDict(parse_query_string(req.query_string))
    ...
    req.query_context['offset'] = query_params.get('offset', None)
    req.query_context['limit'] = query_params.get('limit', 9999)
